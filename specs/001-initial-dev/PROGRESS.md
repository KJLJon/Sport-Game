...
- **Task:** T-4.10 — Arcade → progression
- **Status:** in_progress
- **Started:** 2026-07-28
...
- **Next step:** T-4.10 (progression at a reduced rate), T-4.11 (hot-seat), T-4.12 (accessibility),
  T-4.13 (reward caps and the INV-12 anti-farm check), then Gate 4. **Task order deviated from strict numeric order,
...
| 4 | Arcade framework + basketball arcade set | 13 | 9 | `in_progress` | v0.3 |
